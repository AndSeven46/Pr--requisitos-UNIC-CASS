...
```
Neste guia, vamos usar geditcomo o editor padrão porque é fácil de usar. Se o seu sistema ainda não o tiver, você pode instalá-lo usando o seguinte comando:
```bash
